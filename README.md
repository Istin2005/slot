...
<html>
<head>
    <title>SLOT TIME TABLE - ISTIN (23011206)</title>
    <style>
        table {
...
<img src="{% static 'my_app/logo.png' %}" alt="logo">
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - ISTIN (23011206)</strong></p>
    </div>
    <table>
        <tr>
...
![Screenshot (273)](https://github.com/user-attachments/assets/738844c2-1ff9-466e-9762-0ceaafcba00d)
